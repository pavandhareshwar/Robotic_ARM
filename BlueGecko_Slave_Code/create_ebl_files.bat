...
if "%PATH_GCCARM%"=="" (
  set OBJCOPY=/Applications/Simplicity Studio.app/Contents/Eclipse/developer/toolchains/gnu_arm/4.9_2015q3\bin\arm-none-eabi-objcopy.exe
) else (
...
if "%PATH_SCMD%"=="" (
  set COMMANDER=/Applications/Simplicity Studio.app/Contents/Eclipse/developer/adapter_packs/commander/Commander.app/Contents/MacOS/commander
) else (
